...
#define TARGET_PATH  "/GradersPortalTask2.php" // page we want to fetch with stolen session
#define OUTPUT_FILE  "spoofed-stored.txt" // save the raw HTTP response here
