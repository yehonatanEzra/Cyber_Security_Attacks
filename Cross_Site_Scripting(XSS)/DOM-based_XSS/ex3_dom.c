...
// then we use that stolen cookie to request the real page from the target server and save it to a file
...
#define TARGET_PATH  "/studentManagerDOMBASED.php" // page we want to fetch with stolen session
#define OUTPUT_FILE  "spoofed-dom.txt" // save the raw HTTP response here
